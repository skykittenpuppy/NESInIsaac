local complex = include "NES/libs/complex"
...
function NESEmulator.PALETTE:defacto_palette()
    local p =
        NESEmulator.UTILS.flat_map(
        {
...
function NESEmulator.PALETTE:nestopia_palette()
    return NESEmulator.UTILS.map(
        range(0, 511),
        function(n)
